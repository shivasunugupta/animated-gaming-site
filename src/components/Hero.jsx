...
const Hero = () => {
  ...
  const handleMiniVdClick = () => {
    ...
    setCurrentIndex((prevIndex) => 
      (prevIndex % totalVideos) + 1);
  };

  useGSAP(
    () => {
      if (hasClicked) {
        gsap.set("#next-video", { visibility: 
          "visible" });
        gsap.to("#next-video", {
    ...
    <div className="relative h-dvh w-screen
     overflow-x-hidden">
      {loading && (
        ...
        z-[100] h-dvh w-screen overflow-hidden
         bg-violet-50">
      ...
      >
        <div>
          ...
          <video
            ...
            invisible absolute z-20
             size-64 object-cover 
             object-center"
            onLoadedData={handleVideoLoad}
          />
          <video
